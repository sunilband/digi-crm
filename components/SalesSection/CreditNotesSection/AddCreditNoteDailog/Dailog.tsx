...
import { createCreditNote } from "@/utils/apiRequests/sales functions/CreditNoteFunctions";
  ...
  const addCreditNote = () => {
    ...
    if (user?.token) {
      createCreditNote(user?.token, {
        ...
        creditNoteNumber: formik.values.creditNoteNumber,
        ...
        if (res.success) {
          ...
          toast({
            title: "Success",
            description: "CreditNote created successfully",
          });
        }
        if (res.error) {
          toast({
        ...
        <div className="flex justify-around">
          ...
          >
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="creditNoteNumber" className="text-right">
                CreditNote Number
              </Label>
              <Input
                id="creditNoteNumber"
          ...
          <div className="flex flex-col gap-4 py-4 w-[40%] h-[50%]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="col-span-4 h-52 mt-4 flex flex-col gap-4">
                ...
                <Button type="submit" onClick={addCreditNote}>
                  Save
                </Button>
              </div>
            </div>
